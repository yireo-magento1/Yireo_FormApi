/**
 * Thanks to Andrei Tara
 * @link: http://andreitara.com/2012/02/using-magento-product-chooser-widget-in-youre-own-module/
 */

var YireoFormApiProducts = new Class.create();
YireoFormApiProducts.postAction = function (url, elementId) {
    new Ajax.Request(
    url, {
        method: "post",
...
VarienRulesForm.prototype = {
    initialize: function (a) {
        ...
        this.updateElement = $("product_container");
